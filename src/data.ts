...
export let zooEventsData: Object[] = [
  {
      ...
      Id: 17,
      Subject: 'Story Time for Kids',
      StartTime: new Date(2021, 1, 13, 14, 30),
      EndTime: new Date(2021, 1, 13, 16, 0),
      CategoryColor: '#1aaa55'
  }, {
      Id: 18,
      Subject: 'Black Cockatoos Playtime',
      StartTime: new Date(2021, 1, 15, 14, 30),
...
export let employeeEventData: Object[] = [
  {
      ...
      EndTime: new Date(2021, 1, 12, 11, 0),
      CategoryColor: '#1aaa55'
  }, {
      Id: 2,
      Subject: 'Project Requirement Planning',
      StartTime: new Date(2021, 1, 13, 11, 30),
      EndTime: new Date(2021, 1, 13, 14, 0),
      CategoryColor: '#357cd2'
  }, {
      Id: 3,
      Subject: 'Quality Analysis',
      StartTime: new Date(2021, 1, 14, 9, 30),
      EndTime: new Date(2021, 1, 14, 11, 0),
      CategoryColor: '#7fa900'
  }, {
      Id: 4,
      Subject: 'Timeline Estimation',
      StartTime: new Date(2021, 1, 14, 11, 30),
      EndTime: new Date(2021, 1, 14, 14, 0),
      CategoryColor: '#ea7a57'
  }, {
      Id: 5,
      ...
      EndTime: new Date(2021, 1, 19, 11, 30),
      CategoryColor: '#1aaa55'
  }, {
      Id: 8,
      Subject: 'Project Review - 1',
      StartTime: new Date(2021, 1, 20, 11, 0),
      EndTime: new Date(2021, 1, 20, 12, 30),
      CategoryColor: '#357cd2'
  }, {
      Id: 9,
      ...
      EndTime: new Date(2021, 1, 22, 12, 30),
      CategoryColor: '#ea7a57'
  }, {
      Id: 11,
      Subject: 'Project Output Preview',
      StartTime: new Date(2021, 1, 23, 9, 30),
      EndTime: new Date(2021, 1, 23, 12, 0),
      CategoryColor: '#00bdae'
  }, {
      Id: 12,
      ...
      EndTime: new Date(2021, 1, 27, 13, 0),
      CategoryColor: '#1aaa55'
  }, {
      Id: 14,
      Subject: 'Online Hosting of Project',
      StartTime: new Date(2021, 1, 28, 10, 0),
      EndTime: new Date(2021, 1, 28, 11, 30),
      CategoryColor: '#357cd2'
  }, {
      Id: 15,
      Subject: 'Project Submission to Client',
      StartTime: new Date(2021, 2, 1, 10, 0),
      EndTime: new Date(2021, 2, 1, 13, 0),
      CategoryColor: '#7fa900'
  }, {
      Id: 16,
      Subject: 'Review meeting with Client',
      StartTime: new Date(2021, 2, 2, 10, 0),
      EndTime: new Date(2021, 2, 2, 11, 30),
      CategoryColor: '#ea7a57'
  }
];
...
export let doctorsEventData: Object[] = [
  {
      ...
      EventType: 'Requested',
      StartTime: new Date(2021, 1, 12, 11, 30),
      EndTime: new Date(2021, 1, 12, 12, 30)
  }, {
      Id: 4,
      Subject: 'Observation - Steven',
      EventType: 'Confirmed',
      StartTime: new Date(2021, 1, 12, 12, 30),
      EndTime: new Date(2021, 1, 12, 13, 30)
  }, {
      Id: 5,
      Subject: 'Extraction - Nancy',
      EventType: 'Confirmed',
      StartTime: new Date(2021, 1, 12, 13, 30),
      EndTime: new Date(2021, 1, 12, 15, 0)
  }, {
      Id: 6,
      Subject: 'Surgery - Paul',
      EventType: 'New',
      StartTime: new Date(2021, 1, 13, 9, 0),
      EndTime: new Date(2021, 1, 13, 10, 0)
  }, {
      Id: 7,
      ...
      EventType: 'Confirmed',
      StartTime: new Date(2021, 1, 13, 11, 0),
      EndTime: new Date(2021, 1, 13, 12, 0)
  }, {
      Id: 9,
      Subject: 'Therapy - Saveley',
      EventType: 'Requested',
      StartTime: new Date(2021, 1, 13, 12, 0),
      EndTime: new Date(2021, 1, 13, 13, 30)
  }, {
      Id: 10,
      Subject: 'Observation - Cartrain',
      EventType: 'Confirmed',
      StartTime: new Date(2021, 1, 13, 13, 30),
      EndTime: new Date(2021, 1, 13, 15, 30)
  }, {
      Id: 11,
      ...
      EventType: 'Confirmed',
      StartTime: new Date(2021, 1, 14, 11, 30),
      EndTime: new Date(2021, 1, 14, 12, 30)
  }, {
      Id: 14,
      Subject: 'Extraction - Francisco',
      EventType: 'Requested',
      StartTime: new Date(2021, 1, 14, 12, 30),
      EndTime: new Date(2021, 1, 14, 13, 30)
  }, {
      Id: 15,
      Subject: 'Therapy - Henriette',
      EventType: 'Confirmed',
      StartTime: new Date(2021, 1, 14, 13, 30),
      EndTime: new Date(2021, 1, 14, 15, 0)
  }, {
      Id: 16,
      ...
      EventType: 'Requested',
      StartTime: new Date(2021, 1, 15, 13, 30),
      EndTime: new Date(2021, 1, 15, 15, 30)
  }, {
      Id: 21,
...
export let doctorData: Object[] = [
  {
      ...
      EndTime: new Date(2021, 3, 2, 11, 30),
      IsAllDay: false,
      DoctorId: 1
  }, {
      Id: 2,
      ...
      StartTime: new Date(2021, 3, 2, 8),
      EndTime: new Date(2021, 3, 2, 10, 30),
      IsAllDay: false,
      DoctorId: 3
  }, {
      Id: 4,
      Subject: 'Ambulatory ECG',
      StartTime: new Date(2021, 3, 3, 12),
      ...
      StartTime: new Date(2021, 3, 3, 11),
      EndTime: new Date(2021, 3, 3, 11, 50),
      IsAllDay: false,
      DoctorId: 3
  }, {
      Id: 6,
      Subject: 'Neuromuscular',
      StartTime: new Date(2021, 3, 4, 11, 30),
      ...
      StartTime: new Date(2021, 3, 4, 13, 40),
      EndTime: new Date(2021, 3, 4, 14, 40),
      IsAllDay: false,
      DoctorId: 3
  }, {
      Id: 8,
      ...
      StartTime: new Date(2021, 3, 5, 14),
      EndTime: new Date(2021, 3, 5, 15, 30),
      IsAllDay: false,
      DoctorId: 3
  }, {
      Id: 10,
      Subject: 'Sleep disorders',
      StartTime: new Date(2021, 3, 6, 12),
      EndTime: new Date(2021, 3, 6, 14),
      IsAllDay: false,
      DoctorId: 2
  }, {
      Id: 11,
      Subject: 'Torn ligaments',
      StartTime: new Date(2021, 3, 6, 13, 30),
      EndTime: new Date(2021, 3, 6, 14, 45),
      IsAllDay: false,
      DoctorId: 3
  }, {
      Id: 12,
      ...
      StartTime: new Date(2021, 3, 9, 12),
      EndTime: new Date(2021, 3, 9, 12, 30),
      IsAllDay: false,
      DoctorId: 1
  }, {
      Id: 14,
      ...
      StartTime: new Date(2021, 3, 10, 10),
      EndTime: new Date(2021, 3, 10, 10, 30),
      IsAllDay: false,
      DoctorId: 1
  }, {
      Id: 17,
      Subject: 'Tendon injuries',
      StartTime: new Date(2021, 3, 10, 14),
      EndTime: new Date(2021, 3, 10, 15, 30),
      IsAllDay: false,
      DoctorId: 3
  }, {
      Id: 18,
      Subject: 'Dementia',
      StartTime: new Date(2021, 3, 11, 15),
      EndTime: new Date(2021, 3, 11, 17),
      IsAllDay: false,
      DoctorId: 2
  }, {
      Id: 19,
      Subject: 'Pulled muscles',
      StartTime: new Date(2021, 3, 11, 13, 30),
      EndTime: new Date(2021, 3, 11, 15, 50),
      IsAllDay: false,
      DoctorId: 3
  }, {
      Id: 20,
      ...
      Subject: 'Back pain',
      StartTime: new Date(2021, 3, 12, 10, 30),
      EndTime: new Date(2021, 3, 12, 11, 30),
      IsAllDay: false,
      DoctorId: 3
  }, {
      Id: 22,
      Subject: 'Neuropathy',
      StartTime: new Date(2021, 3, 13, 12, 30),
      EndTime: new Date(2021, 3, 13, 13, 45),
      IsAllDay: false,
      DoctorId: 2
  }, {
      Id: 23,
      Subject: 'Ruptured disks',
      StartTime: new Date(2021, 3, 13, 13),
      EndTime: new Date(2021, 3, 13, 15, 50),
      IsAllDay: false,
      DoctorId: 3
  }, {
      Id: 24,
      ...
      StartTime: new Date(2021, 3, 16, 13, 10),
      EndTime: new Date(2021, 3, 16, 15, 20),
      IsAllDay: false,
      DoctorId: 3
  }, {
      Id: 28,
      Subject: 'Consulting',
      StartTime: new Date(2021, 3, 17, 9, 20),
      EndTime: new Date(2021, 3, 17, 10, 30),
      IsAllDay: false,
      DoctorId: 1
  }, {
      Id: 29,
      Subject: 'Hand surgery',
      StartTime: new Date(2021, 3, 17, 13, 20),
      EndTime: new Date(2021, 3, 17, 15, 22),
      IsAllDay: false,
      DoctorId: 3
  }, {
      Id: 30,
      Subject: 'Neuromuscular',
      StartTime: new Date(2021, 3, 18, 14),
      EndTime: new Date(2021, 3, 18, 15, 40),
      IsAllDay: false,
      DoctorId: 2
  }, {
      Id: 31,
      Subject: 'Spine surgery',
      StartTime: new Date(2021, 3, 18, 12, 18),
      EndTime: new Date(2021, 3, 18, 14, 23),
      IsAllDay: false,
      DoctorId: 3
  }, {
      Id: 32,
      ...
      Id: 33,
      Subject: 'Bone tumors',
      StartTime: new Date(2021, 3, 19, 10, 45),
      EndTime: new Date(2021, 3, 19, 12, 20),
      IsAllDay: false,
      DoctorId: 3
  }, {
      Id: 34,
      Subject: 'Neuromuscular',
      StartTime: new Date(2021, 3, 20, 13),
      EndTime: new Date(2021, 3, 20, 17),
      IsAllDay: false,
      DoctorId: 2
  }, {
      Id: 35,
      Subject: 'Osteoporosis',
      StartTime: new Date(2021, 3, 20, 11, 45),
      EndTime: new Date(2021, 3, 20, 14, 30),
      IsAllDay: false,
      DoctorId: 3
  }, {
      Id: 36,
      ...
      Id: 37,
      Subject: 'Fibrinogen',
      StartTime: new Date(2021, 3, 23, 8),
      EndTime: new Date(2021, 3, 23, 12, 30),
      IsAllDay: false,
      DoctorId: 1
  }, {
      Id: 38,
      ...
      Id: 39,
      Subject: 'Arthroplasty',
      StartTime: new Date(2021, 3, 23, 12, 18),
      EndTime: new Date(2021, 3, 23, 13, 22),
      IsAllDay: false,
      DoctorId: 3
  }, {
      Id: 40,
      Subject: 'Echocardiogram',
      StartTime: new Date(2021, 3, 24, 10, 30),
      EndTime: new Date(2021, 3, 24, 12, 40),
      IsAllDay: false,
      DoctorId: 1
  }, {
      Id: 41,
      Subject: 'Skull reconstruction',
      StartTime: new Date(2021, 3, 24, 13, 20),
      EndTime: new Date(2021, 3, 24, 15, 45),
      IsAllDay: false,
      DoctorId: 3
  }, {
      Id: 42,
      Subject: 'Dementia',
      StartTime: new Date(2021, 3, 25, 12, 30),
      EndTime: new Date(2021, 3, 25, 16, 45),
      IsAllDay: false,
      DoctorId: 2
  }, {
      Id: 43,
      Subject: 'Orthopedic trauma',
      StartTime: new Date(2021, 3, 25, 10, 18),
      EndTime: new Date(2021, 3, 25, 12, 20),
      IsAllDay: false,
      DoctorId: 3
  }, {
      Id: 44,
      ...
      Id: 45,
      Subject: 'Ruptured disks',
      StartTime: new Date(2021, 3, 26, 12, 50),
      EndTime: new Date(2021, 3, 26, 15, 20),
      IsAllDay: false,
      DoctorId: 3
  }, {
      Id: 46,
      Subject: 'Head trauma',
      StartTime: new Date(2021, 3, 27, 11, 50),
      EndTime: new Date(2021, 3, 27, 12, 45),
      IsAllDay: false,
      DoctorId: 2
  }, {
      Id: 47,
      Subject: 'Cerebral palsy',
      StartTime: new Date(2021, 3, 27, 14, 50),
      EndTime: new Date(2021, 3, 27, 15, 50),
      IsAllDay: false,
      DoctorId: 3
  }, {
      Id: 48,
...
export function generateObject(start: number = new Date(2017, 6, 1).getTime(), end: number = new Date(2021, 6, 31).getTime()): Object[] {
  let data: Object[] = [];
  let names: string[] = [
...
export let roomData: Object[] = [
  ...
  },
  {
      ...
      Subject: 'Support Meeting with Managers',
      Description: 'Meeting to discuss support plan.',
      StartTime: new Date(2021, 7, 1, 16, 0),
...
export let hospitalData: Object[] = [
  {
      ...
      Name: 'David',
      StartTime: new Date(2021, 7, 1, 9, 0),
      EndTime: new Date(2021, 7, 1, 10, 0),
      ...
      Id: 12,
      Name: 'Peter',
      StartTime: new Date(2021, 7, 1, 12, 0),
      EndTime: new Date(2021, 7, 1, 13, 0),
      ...
      Name: 'Starc',
      StartTime: new Date(2021, 7, 1, 14, 0),
      EndTime: new Date(2021, 7, 1, 15, 0),
      ...
      Id: 17,
      Name: 'Louis',
      StartTime: new Date(2021, 7, 2, 12, 30),
      EndTime: new Date(2021, 7, 2, 13, 45),
  ...
  },
  {
      ...
      EndTime: new Date(2021, 7, 2, 18, 15),
      ...
      Id: 20,
      Name: 'John',
      StartTime: new Date(2021, 7, 2, 19, 30),
      EndTime: new Date(2021, 7, 2, 21, 45),
      Description: 'Toothaches',
      DepartmentID: 2,
      ConsultantID: 2,
      DepartmentName: 'DENTAL'
      ...
      Id: 21,
      Name: 'Peter',
      StartTime: new Date(2021, 7, 3, 17, 30),
      EndTime: new Date(2021, 7, 3, 19, 30),
      ...
      Id: 22,
      Name: 'Starc',
      StartTime: new Date(2021, 7, 4, 18, 30),
      EndTime: new Date(2021, 7, 4, 21, 30),
      ...
      Id: 23,
      Name: 'James',
      StartTime: new Date(2021, 7, 3, 19, 0),
      EndTime: new Date(2021, 7, 3, 21, 0),
      Description: 'General Checkup',
      DepartmentID: 1,
      ConsultantID: 5,
      DepartmentName: 'GENERAL'
      ...
      Id: 24,
      Name: 'Jercy',
      StartTime: new Date(2021, 7, 4, 20, 0),
      EndTime: new Date(2021, 7, 4, 22, 0),
      Description: 'Tooth Erosion',
      DepartmentID: 2,
      ConsultantID: 6,
      DepartmentName: 'DENTAL'
...
export let waitingList: { [key: string]: Object }[] = [
  {
      Id: 1,
      Name: 'Steven',
      StartTime: new Date(2021, 8, 3, 7, 30),
      EndTime: new Date(2021, 8, 3, 9, 30),
  ...
  },
  {
      Id: 2,
      Name: 'Milan',
      StartTime: new Date(2021, 8, 4, 8, 30),
      EndTime: new Date(2021, 8, 4, 10, 30),
  ...
  },
  {
      Id: 3,
      Name: 'Laura',
      StartTime: new Date(2021, 8, 4, 9, 30),
      EndTime: new Date(2021, 8, 4, 10, 30),
  ...
  },
  {
      Id: 4,
      Name: 'Janet',
      StartTime: new Date(2021, 8, 3, 11, 0),
      EndTime: new Date(2021, 8, 3, 12, 30),
...
export let blockData: Object[] = [
  {
      ...
      Subject: 'Not Available',
      StartTime: new Date(2021, 7, 1, 12, 0),
      EndTime: new Date(2021, 7, 1, 14, 0),
      IsAllDay: false,
      IsBlock: true,
      EmployeeId: 3
  }, {
      Id: 4,
      Subject: 'Not Available',
      StartTime: new Date(2021, 7, 4, 11, 0),
      EndTime: new Date(2021, 7, 5, 10, 0),
      IsAllDay: true,
      IsBlock: true,
      EmployeeId: 4
  }, {
      Id: 5,
      Subject: 'Not Available',
      StartTime: new Date(2021, 7, 10, 11, 0),
      EndTime: new Date(2021, 7, 12, 10, 0),
      IsAllDay: false,
      IsBlock: true,
      EmployeeId: 5
  }, {
      Id: 6,
      Subject: 'Not Available',
      StartTime: new Date(2021, 7, 8),
      EndTime: new Date(2021, 7, 11),
      IsAllDay: false,
      IsBlock: true,
      EmployeeId: 6
  }, {
      Id: 9,
      Subject: 'Client Meeting',
      StartTime: new Date(2021, 7, 3, 8, 0),
      EndTime: new Date(2021, 7, 3, 10, 30),
      IsAllDay: false,
      EmployeeId: 3
  }, {
      Id: 10,
      Subject: 'Conference',
      StartTime: new Date(2021, 7, 2, 13, 30),
      ...
      Id: 15,
      Subject: 'Not Available',
      StartTime: new Date(2021, 7, 29, 11, 0),
      EndTime: new Date(2021, 7, 31, 10, 0),
      IsAllDay: false,
      IsBlock: true,
      EmployeeId: 4
  }, {
...
export let resourceSampleData: Object[] = [
  {
      ...
      Subject: 'Burning Man',
      StartTime: new Date(2021, 5, 1, 15, 0),
      EndTime: new Date(2021, 5, 1, 17, 30),
      OwnerId: 1
  }, {
      Id: 2,
      Subject: 'Marketing Forum',
      StartTime: new Date(2021, 5, 3, 10, 0),
      EndTime: new Date(2021, 5, 3, 11, 30),
      OwnerId: 2
  }, {
      Id: 3,
      Subject: 'Business Factory',
      StartTime: new Date(2021, 5, 3, 13, 30),
      EndTime: new Date(2021, 5, 3, 15, 0),
      OwnerId: 3
  }, {
      Id: 4,
      Subject: 'Burning Man',
      StartTime: new Date(2021, 5, 4, 11, 30),
      EndTime: new Date(2021, 5, 4, 13, 0),
      OwnerId: 1
  }, {
      Id: 5,
      Subject: 'Funnel Hacking',
      StartTime: new Date(2021, 5, 5, 9, 30),
      EndTime: new Date(2021, 5, 5, 11, 0),
      OwnerId: 3
  }, {
      Id: 6,
      Subject: 'The human gathering"',
      StartTime: new Date(2021, 5, 5, 13, 0),
      EndTime: new Date(2021, 5, 5, 14, 30),
      OwnerId: 2
  }, {
      Id: 7,
      Subject: 'Techweek',
      StartTime: new Date(2021, 5, 6, 11, 0),
      EndTime: new Date(2021, 5, 6, 12, 30),
      OwnerId: 2
  }, {
      Id: 8,
      Subject: 'Grow Conference',
      StartTime: new Date(2021, 5, 7, 10, 0),
      EndTime: new Date(2021, 5, 7, 11, 30),
      OwnerId: 1
  }, {
      Id: 9,
      Subject: 'Data Science Conference',
      StartTime: new Date(2021, 5, 7, 13, 30),
      EndTime: new Date(2021, 5, 7, 15, 0),
      OwnerId: 1
  }, {
      Id: 10,
      Subject: 'Blogcademy',
      StartTime: new Date(2021, 5, 8, 12, 0),
      EndTime: new Date(2021, 5, 8, 13, 30),
      OwnerId: 3
  }, {
      Id: 11,
      Subject: 'World Domination Summit',
      StartTime: new Date(2021, 5, 9, 9, 30),
      EndTime: new Date(2021, 5, 9, 11, 0),
      OwnerId: 2
  }, {
      Id: 12,
      Subject: 'Content Marketing',
      StartTime: new Date(2021, 5, 9, 13, 0),
      EndTime: new Date(2021, 5, 9, 14, 30),
      OwnerId: 1
  }, {
      Id: 13,
      Subject: 'Mobile World Conference',
